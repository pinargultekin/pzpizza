...
function MeatList(props) {
  ...
  const intersecPz = itemIngre.filter(element => pizzaMeatTop.includes(element))
  const intersecPs = itemIngre.filter(element => pastaMeatTop.includes(element))
  const intersecSd = itemIngre.filter(element => saladMeatTop.includes(element))
